...
urlpatterns = [
    ...
    url(r'^order-confirmation/<int:pk>/',OrderConfirmation.as_view(),name='order-confirmation'),
    url(r'payment-confirmation',OrderPayConfirmation.as_view(),name= 'payment-submitted'),
